...
\begin{figure}[H]
    \begin{center}
        \includegraphics[width=0.9\linewidth]{Interfaces_UI/Login_UID.png}
        \caption{Login Page.}
        \label{fig:login_page}%
    \end{center}

    \begin{center}
        \includegraphics[width=0.9\linewidth]{Interfaces_UI/Registration_UID.png}
...
\begin{figure}[H]
    \begin{center}
        \includegraphics[width=0.9\linewidth]{Interfaces_UI/ED_Home_UID.png}
        \caption{ED Homepage.}
...
\begin{figure}[H]
    \begin{center}
        \includegraphics[width=0.9\linewidth]{Interfaces_UI/CreateTournament_UID.png}
...
\begin{figure}[H]
    \begin{center}
        \includegraphics[width=0.9\linewidth]{Interfaces_UI/CreateBadge_UID.png}
...
\begin{figure}[H]
    \begin{center}
        \includegraphics[width=0.9\linewidth]{Interfaces_UI/ED_Tour_UID.png}
...
\begin{figure}[H]
    \begin{center}
        \includegraphics[width=0.9\linewidth]{Interfaces_UI/CreateBattle_UID.png}
...
\begin{figure}[H]
    \begin{center}
        \includegraphics[width=0.9\linewidth]{Interfaces_UI/ED_Battle_Leaderboard_UID.png}
...
\begin{figure}[H]
    \begin{center}
        \includegraphics[width=0.9\linewidth]{Interfaces_UI/EvaluateCode_UID.png}
...
\begin{figure}[H]
    \begin{center}
        \includegraphics[width=0.9\linewidth]{Interfaces_UI/ST_home_UID.png}
        \caption{ST Homepage.}
...
\begin{figure}[H]
    \begin{center}
        \includegraphics[width=0.9\linewidth]{Interfaces_UI/ST_Tour_v2.png}
...
\begin{figure}[H]
    \begin{center}
        \includegraphics[width=0.9\linewidth]{Interfaces_UI/CreateGroup_UID.png}
...
\begin{figure}[H]
    \begin{center}
        \includegraphics[width=0.9\linewidth]{Interfaces_UI/ST_Battle_UID.png}
...
\begin{figure}[H]
    \begin{center}
        \includegraphics[width=0.9\linewidth]{Interfaces_UI/ST_profile_UID.png}
        \caption{ST Profile Page.}
        \label{fig:st_profile_page}%
    \end{center}

    \begin{center}
        \includegraphics[width=0.9\linewidth]{Interfaces_UI/ED_profile_UID.png}
