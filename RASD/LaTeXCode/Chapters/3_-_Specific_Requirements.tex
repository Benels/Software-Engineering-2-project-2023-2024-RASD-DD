...
\begin{figure}[H]
    \begin{center}
        \includegraphics[width=1\linewidth]{SequenceDiagrams/create a group and battle confirmation.png}
...
\begin{figure}[H]
    \begin{center}
        \includegraphics[width=.8\linewidth]{SequenceDiagrams/Evaluate a code.png}
