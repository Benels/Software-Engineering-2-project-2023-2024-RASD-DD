...
\begin{center}
    \begin{longtable}{|l|p{0.9\linewidth}|}
        ...
        \textbf{Exceptions}        & \begin{itemize}
            ...
            \item if the invited student isn’t already joined in the competition or if the nickname does not exist, CKB sends an error and redirects the students to the CreateGroup page.
         \end{itemize}    \\
        \hline
